...
summary: "[Auto-summary] Reactive Control (điều khiển phản ứng) là chế độ điều khiển vận động trong đó não không còn thời gian dự đoán và lập kế hoạch đầy đủ — thay vào đó, hệ thần kinh phản ứng gần như tức thời, dựa nhiều vào các mạch thần kinh dưới vỏ não."
source_vi: "co-sinh-hoc\reactive-control-1.md"
