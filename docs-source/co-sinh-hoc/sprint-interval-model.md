...
summary: "[Auto-summary] Sprint Interval Model là training method cho [Explosive Durability](../ky-thuat/explosive-durability.md) — intervals matched chính xác đến actual match demands của tennis, thay vì generic athletic conditioning"
source_vi: "co-sinh-hoc\sprint-interval-model.md"
