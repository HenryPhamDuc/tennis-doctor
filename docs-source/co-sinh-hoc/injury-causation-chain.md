---
title: "Injury Causation Chain"
summary: "[Auto-summary] Injury Causation Chain là framework chẩn đoán chấn thương trong tennis: **mọi upper body injury gần như đều có nguồn gốc từ failure thấp hơn trong kinetic chain** — không phải từ overuse của bộ phận bị thương"
source_vi: "co-sinh-hoc\injury-causation-chain.md"
...
Implication cho coaching practice:
- Coach thấy player có tennis elbow → không phải recommend elbow brace và rest.
- First question: "Is your leg drive compromised? Are your hips clearing before contact?"
- Đây không phải overstepping — đây là chính xác cách injury mechanism works.

**Pre-hab logic**: 25 phút pre-hab (xem [Coaching Conditioning](../ky-thuat/coaching-conditioning.md)) targets the chain BELOW the injury risk point — không targets the vulnerable structure directly. Rotator cuff protection comes from core work, không từ rotator cuff isolation exercises.
...
- [Arming Ratio](../ky-thuat/arming-ratio.md)
- [Oblique Slings](../ky-thuat/oblique-slings.md)
