...
summary: "[Auto-summary] Wrist lag is the deliberate delay of the racket head relative to the forearm during the acceleration phase of a stroke — the wrist remaining in extension (laid back) while the arm moves forward, creating a stretch in the forearm flexors that releases explosively at contact."
source_vi: "co-sinh-hoc\wrist-lag-and-release.md"
