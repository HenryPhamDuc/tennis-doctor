...
summary: "[Auto-summary] Separation Timing là **kinematics của sự trễ tuần tự** giữa pelvis và thorax trong forehand ATP — không chỉ tạo ra X-Factor (góc tách hông-vai), mà còn kiểm soát **thời điểm chính xác** mà sự tách biệt đó đạt đỉnh và được giải phóng"
source_vi: "ky-thuat\separation-timing.md"
