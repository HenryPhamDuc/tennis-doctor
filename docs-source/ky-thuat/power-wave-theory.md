...
summary: "[Auto-summary] The Power Wave is a biomechanical model arguing that tennis stroke power is generated not by sequential muscle contractions (the classic [kinetic chain](kinetic-chain.md)) but by a **propagating wave** traveling through the body — bi-directional, three-dimensional, and capable of goin"
source_vi: "ky-thuat\power-wave-theory.md"
