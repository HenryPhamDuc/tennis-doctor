...
summary: "[Auto-summary] Linear Periodisation là model conditioning của era 2000: build aerobic base → develop sport-specific conditioning → peak for major tournament → recover → repeat"
source_vi: "ky-thuat\linear-periodisation-failure.md"
