...
summary: "[Auto-summary] Affordance Cues are the biomechanical motion signals from the opponent's body that communicate not where the ball is going, but what the opponent is *capable* of doing from their current position"
source_vi: "ky-thuat\affordance-cues.md"
