...
summary: "[Auto-summary] The Agentic Decision Tree is the hierarchical structure of if-then-else tactical conditions that an elite player runs implicitly during a point — processed by the _Basal Ganglia_ rather than the _Prefrontal Cortex_"
source_vi: "ky-thuat\agentic-decision-tree.md"
