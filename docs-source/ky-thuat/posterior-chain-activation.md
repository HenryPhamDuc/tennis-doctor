...
summary: "[Auto-summary] The posterior chain is the set of muscles running along the back of the body — calves (bắp chuối), hamstrings (gân kheo), glutes (mông), and inner thigh/adductors (đùi trong) — that acts as the primary force generator in all three tennis [footwork Stances](footwork-stances.md)."
source_vi: "ky-thuat\posterior-chain-activation.md"
